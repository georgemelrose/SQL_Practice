...
SELECT 
    last_name, 
    CASE 
        WHEN last_name SIMILAR TO '%(enko|vich|vych|chuk|chyk|ski|sky|uk|ko|yshyn|iv)' THEN 'YES' 
        ELSE 'NO' 
    END AS "Ukrainian Surname" 
FROM customer 
WHERE last_name SIMILAR TO '%(enko|vich|vych|chuk|chyk|ski|sky|uk|ko|yshyn|iv)';
