...
The function *dyEvent()* allows vertical lines with a label to be added. *dyAnnotation()* generates annotations directly on the time series line. 
...
p <- dygraph(don,xlab = "Order Date", ylab = "No.Orders",main = "Daily No.Orders from 'cust_order' Table ") %>%
  ...
  dyAnnotation("2023-09-13", text = "September 241 Offer", tooltip = "September 241 Offer") %>%
  dyAnnotation("2023-11-13", text = "November Multi-Buy Offer",tooltip = "September 241 Offer" ) %>%
  dyUnzoom() 
...
The function *dyLimit()* allows line limites to be added.
