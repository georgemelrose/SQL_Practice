...
The function *dyEvent()* allows vertical lines with a label to be added. *dyAnnotation()* generates annotations directly on the time series line. Using a custom function, a larger annotation and attached to the x-axis is also possible, *presAnnotation()* .
*dyshading()* allows whole areas of the graph to be shaded -
