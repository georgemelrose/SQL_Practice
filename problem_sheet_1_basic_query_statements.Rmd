...
\textbf{select first\_name || '  ' || last\_name as full\_name, finish_time, position,sex  from Runners inner join Results on Runners.runner\_id = Results.runner\_id inner join Events on Results.event_id = Events.event_id;}