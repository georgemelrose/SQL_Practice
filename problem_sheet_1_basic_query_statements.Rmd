...
\textbf{select * from Training_Plans_Descriptions where plan\_length\_weeks between 10 and 12;}
...
\textbf{select * from Training_Plans_Descriptions where plan\_length\_weeks <12;}

The \textbf{<} operator after the \textbf{where} clause fetches results below a certain numerical threshold, 12 in this case. 
