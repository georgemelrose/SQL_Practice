...
\textbf{Q1.} - Obtain the full names of all 'elite' runners as well as their finish times, position, and sex? Additionally, gather the information on the events when these elite times were made?

\textbf{Solution} - 

\textbf{select first\_name || '  ' || last\_name as full\_name, finish\_time, position,sex  from Runners inner join Results on Runners.runner\_id = Results.runner\_id inner join Events on Results.event\_id = Events.event\_id;}